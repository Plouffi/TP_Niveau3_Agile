...
public class PersonnelDAO extends DAO<Personnel> {
	...
	/**
	 * Fonction permettant l'insertion d'un Personnel dans la base de donn�es
	 * @param obj
	 * @return boolean
	 * @throws SQLException
	 */
	...
	/**
	 * Fonction permettant la suppression d'un Personnel existant dans la base de donn�es
	 * @param obj
	 * @return boolean
	 * @throws SQLException
	 */
